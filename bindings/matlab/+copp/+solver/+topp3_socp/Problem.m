classdef Problem < copp.solver.topp3.Problem
    %PROBLEM TOPP3-SOCP problem descriptor.
    %
    % This class is a package-specific facade over the shared
    % copp.solver.topp3.Problem descriptor. topp3_socp.solve accepts the
    ...
    methods
        function obj = Problem(robot, a_linearization, opts)
            %PROBLEM Construct a TOPP3-SOCP problem descriptor.
            %
            % P = copp.solver.topp3_socp.Problem(ROBOT, A_LINEARIZATION)
            % creates a descriptor for topp3_socp.solve. Name-value options
            % are the same as copp.solver.topp3.Problem. A shared
